...
const revealElements = document.querySelectorAll('.section-header, .about-text, .skills, .contact-info');
...
console.log('Vassilis\'s Stupendous Site loaded successfully! 🚀');